...
export class TaskService {
  ...
  addTask(task: { title: string; description?: string; dueDate?: string }): Observable<any> {
  return this.http.post('http://localhost:3000/tasks', task);
}

updateTask(id: string, task: { title: string; description?: string; dueDate?: string }): Observable<any> {
